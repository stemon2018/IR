...
const BusinessPipeline = () => {
  ...
  const popupData = {
    "IR-02": "디지털 방식 엑소좀 유도 플랫폼과 엑소좀내 약물탑재 플랫폼을 기반으로  대략 200여종의 기능성 엑소좀을 개발하였습니다. 이를 통해 스템온은 R&D가 아닌 D&R을 행하고 있어며, 이를 기반으로 다양한 난치성 질환에 대한 치료제, 의료기기, 연구용 엑소좀, 미용분야 사업을 B2B로 진행하고 있습니다.",
    ...
    "IR-04": "UltraRepro에 의해 유도된 역분화줄기세포 유래 엑소좀을 기반으로 세계최초로 동물용 창상치료제 품목허가를 2개 받았습니다. 올해 연말 3개의 폼목허가를 더 기대하고 있습니다.",
