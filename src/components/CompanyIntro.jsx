...
const CompanyIntro = () => {
  ...
  const popupData = {
    ...
    "IR-03": "스템온은 2018년 3월에 설립을 하였고 현재 직원이 24명이며 대표이사는 최근까지 의과대학교 교수로 역임하다가 지금은 스템온 대표이사로만 재직중입니다.",
    "IR-04": "스템온은 2018년 3월에 설립을 하였고 현재 직원이 24명이며 대표이사는 최근까지 의과대학교 교수로 역임하다가 지금은 스템온 대표이사로만 재직중입니다.",
    "IR-05": "스템온은 최근 스템온이 갖고 있는 특허를 포함한 다양한 기술이 기술보증기금을 통해 AAA로 평가 받았습니다.",
    "IR-06": "스템온은 최근 스템온이 갖고 있는 특허를 포함한 다양한 기술이 기술보증기금을 통해 AAA로 평가 받았습니다.",
    "IR-07": "스템온은 2023년 홍콩 CPA 기업인 Reanda International로 부터 향후 3년 이내에 유니콘 기업으로 성장이 가능하다고 평가를 받았습니다."
  };
